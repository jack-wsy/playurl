...
Suite Setup  run keyword  get file data  contId  VIP_LIVE  id_save=member_ios_vip_live_contId
...
member-get-playurl-vip-live-480P
    ...
    ${result}  get playurl  ${member_ios_vip_live_contId}  ${salt}  ${sign}  ${timestamp}  ${480P}
...
member-get-playurl-vip-live-540P
    ...
    ${result}  get playurl  ${member_ios_vip_live_contId}  ${salt}  ${sign}  ${timestamp}  ${540P}
...
member-get-playurl-vip-live-720P
    ...
    ${result}  get playurl  ${member_ios_vip_live_contId}  ${salt}  ${sign}  ${timestamp}  ${720P}
...
member-get-playurl-vip-live-1080P
    ...
    ${result}  get playurl  ${member_ios_vip_live_contId}  ${salt}  ${sign}  ${timestamp}  ${1080P}
...
member-get-playurl-vip-live-50-original_painting
    [Documentation]  会员播放VIP直播节目-1080P
    ${result}  get playurl  ${member_ios_vip_live_contId}  ${salt}  ${sign}  ${timestamp}  ${original_painting}
