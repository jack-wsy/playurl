...
Suite Setup  run keyword  get file data  contId  EPISODES_SINGLE  id_save=member_ipad_episodes_contId
...
member-get-playurl-episodes-single-480P
    ...
    ${result}  get playurl  ${member_ipad_episodes_contId}  ${salt}  ${sign}  ${timestamp}  ${480P}
...
member-get-playurl-episodes-single-540P
    ...
    ${result}  get playurl  ${member_ipad_episodes_contId}  ${salt}  ${sign}  ${timestamp}  ${540P}
...
member-get-playurl-episodes-single-720P
    ...
    ${result}  get playurl  ${member_ipad_episodes_contId}  ${salt}  ${sign}  ${timestamp}  ${720P}
...
member-get-playurl-episodes-single-1080P
    ...
    ${result}  get playurl  ${member_ipad_episodes_contId}  ${salt}  ${sign}  ${timestamp}  ${1080P}
...
member-get-playurl-episodes-single-50-original_painting
    ...
    ${result}  get playurl  ${member_ipad_episodes_contId}  ${salt}  ${sign}  ${timestamp}  ${original_painting}
