...
Suite Setup  run keyword  get file data  contId  5G_ORIGINAL_PAINTING  id_save=member_miguc_5g_original_painting_contId
...
member-get-playurl-5g-original-painting-480P
    ...
    ${result}  get playurl  ${member_miguc_5g_original_painting_contId}  ${salt}  ${sign}  ${timestamp}  ${480P}
...
member-get-playurl-5g-original-painting-540P
    ...
    ${result}  get playurl  ${member_miguc_5g_original_painting_contId}  ${salt}  ${sign}  ${timestamp}  ${540P}
...
member-get-playurl-5g-original-painting-720P
    ...
    ${result}  get playurl  ${member_miguc_5g_original_painting_contId}  ${salt}  ${sign}  ${timestamp}  ${720P}
...
member-get-playurl-5g-original-painting-1080P
    ...
    ${result}  get playurl  ${member_miguc_5g_original_painting_contId}  ${salt}  ${sign}  ${timestamp}  ${1080P}
...
member-get-playurl-5g-original-painting-50-original_painting
    ...
    ${result}  get playurl  ${member_miguc_5g_original_painting_contId}  ${salt}  ${sign}  ${timestamp}  ${original_painting}
