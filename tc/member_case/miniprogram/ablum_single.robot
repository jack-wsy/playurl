...
Suite Setup  run keyword  get file data  contId  ABLUM_SINGLE  id_save=member_miniprogram_ablum_single_contId
...
member-get-playurl-ablum-single-480P
    ...
    ${result}  get playurl  ${member_miniprogram_ablum_single_contId}  ${salt}  ${sign}  ${timestamp}  ${480P}
...
member-get-playurl-ablum-single-540P
    ...
    ${result}  get playurl  ${member_miniprogram_ablum_single_contId}  ${salt}  ${sign}  ${timestamp}  ${540P}
...
member-get-playurl-ablum-single-720P
    ...
    ${result}  get playurl  ${member_miniprogram_ablum_single_contId}  ${salt}  ${sign}  ${timestamp}  ${720P}
...
member-get-playurl-ablum-single-1080P
    ...
    ${result}  get playurl  ${member_miniprogram_ablum_single_contId}  ${salt}  ${sign}  ${timestamp}  ${1080P}
...
member-get-playurl-ablum-single-50-original_painting
    ...
    ${result}  get playurl  ${member_miniprogram_ablum_single_contId}  ${salt}  ${sign}  ${timestamp}  ${original_painting}
