...
Suite Setup  run keyword  get file data  contId  LIVE_FREE  id_save=member_miniprogram_live_free_contId
...
member-get-playurl-live-free-480P
    ...
    ${result}  get playurl  ${member_miniprogram_live_free_contId}  ${salt}  ${sign}  ${timestamp}  ${480P}
...
member-get-playurl-live-free-540P
    ...
    ${result}  get playurl  ${member_miniprogram_live_free_contId}  ${salt}  ${sign}  ${timestamp}  ${540P}
...
member-get-playurl-live-free-720P
    ...
    ${result}  get playurl  ${member_miniprogram_live_free_contId}  ${salt}  ${sign}  ${timestamp}  ${720P}
...
member-get-playurl-live-free-1080P
    ...
    ${result}  get playurl  ${member_miniprogram_live_free_contId}  ${salt}  ${sign}  ${timestamp}  ${1080P}
...
member-get-playurl-live-free-50-original_painting
    [Documentation]  会员播放直播免费节目-1080P
    ${result}  get playurl  ${member_miniprogram_live_free_contId}  ${salt}  ${sign}  ${timestamp}  ${original_painting}
