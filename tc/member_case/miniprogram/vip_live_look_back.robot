...
Suite Setup  run keyword  get file data  contId  VIP_LIVE_LOOK_BACK  id_save=member_miniprogram_vip_live_look_back_contId
...
member-get-playurl-vip-live-look-back-480P
    ...
    ${result}  get playurl  ${member_miniprogram_vip_live_look_back_contId}  ${salt}  ${sign}  ${timestamp}  ${480P}
...
member-get-playurl-vip-live-look-back-540P
    ...
    ${result}  get playurl  ${member_miniprogram_vip_live_look_back_contId}  ${salt}  ${sign}  ${timestamp}  ${540P}
...
member-get-playurl-vip-live-look-back-720P
    ...
    ${result}  get playurl  ${member_miniprogram_vip_live_look_back_contId}  ${salt}  ${sign}  ${timestamp}  ${720P}
...
member-get-playurl-vip-live-look-back-1080P
    ...
    ${result}  get playurl  ${member_miniprogram_vip_live_look_back_contId}  ${salt}  ${sign}  ${timestamp}  ${1080P}
...
member-get-playurl-vip-live-look-back-50-original_painting
    [Documentation]  会员播放VIP直播回看节目-1080P
    ${result}  get playurl  ${member_miniprogram_vip_live_look_back_contId}  ${salt}  ${sign}  ${timestamp}  ${original_painting}
