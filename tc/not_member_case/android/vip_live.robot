...
Suite Setup  run keyword  get file data  contId  VIP_LIVE  id_save=not_member_android_vip_live_contId
...
not_member-get-playurl-vip-live-480P
    ...
    ${result}  get playurl  ${not_member_android_vip_live_contId}  ${salt}  ${sign}  ${timestamp}  ${480P}
...
not_member-get-playurl-vip-live-540P
    ...
    ${result}  get playurl  ${not_member_android_vip_live_contId}  ${salt}  ${sign}  ${timestamp}  ${540P}
...
not_member-get-playurl-vip-live-720P
    ...
    ${result}  get playurl  ${not_member_android_vip_live_contId}  ${salt}  ${sign}  ${timestamp}  ${720P}
...
not_member-get-playurl-vip-live-1080P
    ...
    ${result}  get playurl  ${not_member_android_vip_live_contId}  ${salt}  ${sign}  ${timestamp}  ${1080P}
...
not_member-get-playurl-vip-live-50-original_painting
    [Documentation]  非会员播放VIP直播节目-1080P
    ${result}  get playurl  ${not_member_android_vip_live_contId}  ${salt}  ${sign}  ${timestamp}  ${original_painting}
