...
Suite Setup  run keyword  get file data  contId  VIP_LIVE_LOOK_BACK  id_save=not_member_ios_vip_live_look_back_contId
...
not_member-get-playurl-vip-live-look-back-480P
    ...
    ${result}  get playurl  ${not_member_ios_vip_live_look_back_contId}  ${salt}  ${sign}  ${timestamp}  ${480P}
...
not_member-get-playurl-vip-live-look-back-540P
    ...
    ${result}  get playurl  ${not_member_ios_vip_live_look_back_contId}  ${salt}  ${sign}  ${timestamp}  ${540P}
...
not_member-get-playurl-vip-live-look-back-720P
    ...
    ${result}  get playurl  ${not_member_ios_vip_live_look_back_contId}  ${salt}  ${sign}  ${timestamp}  ${720P}
...
not_member-get-playurl-vip-live-look-back-1080P
    ...
    ${result}  get playurl  ${not_member_ios_vip_live_look_back_contId}  ${salt}  ${sign}  ${timestamp}  ${1080P}
...
not_member-get-playurl-vip-live-look-back-50-original_painting
    [Documentation]  非会员播放VIP直播回看节目-1080P
    ${result}  get playurl  ${not_member_ios_vip_live_look_back_contId}  ${salt}  ${sign}  ${timestamp}  ${original_painting}
