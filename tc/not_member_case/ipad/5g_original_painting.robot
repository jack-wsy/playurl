...
Suite Setup  run keyword  get file data  contId  5G_ORIGINAL_PAINTING  id_save=not_member_ipad_5g_original_painting_contId
...
not_member-get-playurl-5g-original-painting-480P
    ...
    ${result}  get playurl  ${not_member_ipad_5g_original_painting_contId}  ${salt}  ${sign}  ${timestamp}  ${480P}
...
not_member-get-playurl-5g-original-painting-540P
    ...
    ${result}  get playurl  ${not_member_ipad_5g_original_painting_contId}  ${salt}  ${sign}  ${timestamp}  ${540P}
...
not_member-get-playurl-5g-original-painting-720P
    ...
    ${result}  get playurl  ${not_member_ipad_5g_original_painting_contId}  ${salt}  ${sign}  ${timestamp}  ${720P}
...
not_member-get-playurl-5g-original-painting-1080P
    ...
    ${result}  get playurl  ${not_member_ipad_5g_original_painting_contId}  ${salt}  ${sign}  ${timestamp}  ${1080P}
...
not_member-get-playurl-5g-original-painting-50-original_painting
    ...
    ${result}  get playurl  ${not_member_ipad_5g_original_painting_contId}  ${salt}  ${sign}  ${timestamp}  ${original_painting}
