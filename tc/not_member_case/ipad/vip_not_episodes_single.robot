...
Suite Setup  run keyword  get file data  contId  VIP_NOT_EPISODES_SINGLE  id_save=not_member_ipad_vip_not_episodes_contId
...
not_member-get-playurl-vip-not-episodes-single-480P
    ...
    ${result}  get playurl  ${not_member_ipad_vip_not_episodes_contId}  ${salt}  ${sign}  ${timestamp}  ${480P}
...
not_member-get-playurl-vip-not-episodes-single-540P
    ...
    ${result}  get playurl  ${not_member_ipad_vip_not_episodes_contId}  ${salt}  ${sign}  ${timestamp}  ${540P}
...
not_member-get-playurl-vip-not-episodes-single-720P
    ...
    ${result}  get playurl  ${not_member_ipad_vip_not_episodes_contId}  ${salt}  ${sign}  ${timestamp}  ${720P}
...
not_member-get-playurl-vip-not-episodes-single-1080P
    ...
    ${result}  get playurl  ${not_member_ipad_vip_not_episodes_contId}  ${salt}  ${sign}  ${timestamp}  ${1080P}
...
not_member-get-playurl-vip-not-episodes-single-50-original_painting
    ...
    ${result}  get playurl  ${not_member_ipad_vip_not_episodes_contId}  ${salt}  ${sign}  ${timestamp}  ${original_painting}
