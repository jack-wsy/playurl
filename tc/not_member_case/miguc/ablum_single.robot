...
Suite Setup  run keyword  get file data  contId  ABLUM_SINGLE  id_save=not_member_miguc_ablum_single_contId
...
not_member-get-playurl-ablum-single-480P
    ...
    ${result}  get playurl  ${not_member_miguc_ablum_single_contId}  ${salt}  ${sign}  ${timestamp}  ${480P}
...
not_member-get-playurl-ablum-single-540P
    ...
    ${result}  get playurl  ${not_member_miguc_ablum_single_contId}  ${salt}  ${sign}  ${timestamp}  ${540P}
...
not_member-get-playurl-ablum-single-720P
    ...
    ${result}  get playurl  ${not_member_miguc_ablum_single_contId}  ${salt}  ${sign}  ${timestamp}  ${720P}
...
not_member-get-playurl-ablum-single-1080P
    ...
    ${result}  get playurl  ${not_member_miguc_ablum_single_contId}  ${salt}  ${sign}  ${timestamp}  ${1080P}
...
not_member-get-playurl-ablum-single-50-original_painting
    ...
    ${result}  get playurl  ${not_member_miguc_ablum_single_contId}  ${salt}  ${sign}  ${timestamp}  ${original_painting}
