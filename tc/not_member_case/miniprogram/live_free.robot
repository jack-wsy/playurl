...
Suite Setup  run keyword  get file data  contId  LIVE_FREE  id_save=not_member_miniprogram_live_free_contId
...
not_member-get-playurl-live-free-480P
    ...
    ${result}  get playurl  ${not_member_miniprogram_live_free_contId}  ${salt}  ${sign}  ${timestamp}  ${480P}
...
not_member-get-playurl-live-free-540P
    ...
    ${result}  get playurl  ${not_member_miniprogram_live_free_contId}  ${salt}  ${sign}  ${timestamp}  ${540P}
...
not_member-get-playurl-live-free-720P
    ...
    ${result}  get playurl  ${not_member_miniprogram_live_free_contId}  ${salt}  ${sign}  ${timestamp}  ${720P}
...
not_member-get-playurl-live-free-1080P
    ...
    ${result}  get playurl  ${not_member_miniprogram_live_free_contId}  ${salt}  ${sign}  ${timestamp}  ${1080P}
...
not_member-get-playurl-live-free-50-original_painting
    [Documentation]  非会员播放直播免费节目-1080P
    ${result}  get playurl  ${not_member_miniprogram_live_free_contId}  ${salt}  ${sign}  ${timestamp}  ${original_painting}
