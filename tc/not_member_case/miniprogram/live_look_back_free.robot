...
Suite Setup  run keyword  get file data  contId  LIVE_LOOK_BACK_FREE  id_save=not_member_miniprogram_live_look_back_free_contId
...
not_member-get-playurl-live-look-back-free-480P
    ...
    ${result}  get playurl  ${not_member_miniprogram_live_look_back_free_contId}  ${salt}  ${sign}  ${timestamp}  ${480P}
...
not_member-get-playurl-live-look-back-free-540P
    ...
    ${result}  get playurl  ${not_member_miniprogram_live_look_back_free_contId}  ${salt}  ${sign}  ${timestamp}  ${540P}
...
not_member-get-playurl-live-look-back-free-720P
    ...
    ${result}  get playurl  ${not_member_miniprogram_live_look_back_free_contId}  ${salt}  ${sign}  ${timestamp}  ${720P}
...
not_member-get-playurl-live-look-back-free-1080P
    ...
    ${result}  get playurl  ${not_member_miniprogram_live_look_back_free_contId}  ${salt}  ${sign}  ${timestamp}  ${1080P}
...
not_member-get-playurl-live-look-back-free-50-original_painting
    [Documentation]  非会员播放直播免费回看节目-1080P
    ${result}  get playurl  ${not_member_miniprogram_live_look_back_free_contId}  ${salt}  ${sign}  ${timestamp}  ${original_painting}
