*** Settings ***
Library  pylib.playUrlVr.PlayUrlVR  ${not_member_header}
Library  pylib/myfunction.py
Resource    rflib/tempparam.robot

*** Test Cases ***
not_member-get-playurl-VR-4K-800
    [Documentation]  非会员点播VR-4K-巨幕-2D
    ...
    ${verify_value}  get file data  not_member_verify  NOT_MEMBER  VR-4K-800  4K
    ${verify}  verify result  ${result}  &{verify_value}
    should be true  ${verify}

not_member-get-playurl-VR-4K-801
    [Documentation]  非会员点播VR-4K-全景-2D
    ...
    ${verify_value}  get file data  not_member_verify  NOT_MEMBER  VR-4K-801  4K
    ${verify}  verify result  ${result}  &{verify_value}
    should be true  ${verify}

not_member-get-playurl-VR-4K-802
    [Documentation]  非会员直播VR_4K_全景2D
    ...
    ${verify_value}  get file data  not_member_verify  NOT_MEMBER  VR-4K-802  4K
    ${verify}  verify result  ${result}  &{verify_value}
    should be true  ${verify}

not_member-get-playurl-VR-4K-805
    [Documentation]  非会员点播VR-805
    ...
    ${verify_value}  get file data  not_member_verify  NOT_MEMBER  VR-4K-805  4K
    ${verify}  verify result  ${result}  &{verify_value}
    should be true  ${verify}

not_member-get-playurl-VR-4K-805-bak
    [Documentation]  非会员点播VR-805-bak
    ...
    ${verify_value}  get file data  not_member_verify  NOT_MEMBER  VR-4K-805-bak  4K
    ${verify}  verify result  ${result}  &{verify_value}
    should be true  ${verify}