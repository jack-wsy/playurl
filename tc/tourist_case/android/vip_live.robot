...
Suite Setup  run keyword  get file data  contId  VIP_LIVE  id_save=tourist_android_vip_live_contId
...
tourist-get-playurl-vip-live-480P
    ...
    ${result}  get playurl  ${tourist_android_vip_live_contId}  ${salt}  ${sign}  ${timestamp}  ${480P}
...
tourist-get-playurl-vip-live-540P
    ...
    ${result}  get playurl  ${tourist_android_vip_live_contId}  ${salt}  ${sign}  ${timestamp}  ${540P}
...
tourist-get-playurl-vip-live-720P
    ...
    ${result}  get playurl  ${tourist_android_vip_live_contId}  ${salt}  ${sign}  ${timestamp}  ${720P}
...
tourist-get-playurl-vip-live-1080P
    ...
    ${result}  get playurl  ${tourist_android_vip_live_contId}  ${salt}  ${sign}  ${timestamp}  ${1080P}
...
tourist-get-playurl-vip-live-50-original_painting
    [Documentation]  游客播放VIP直播节目-1080P
    ${result}  get playurl  ${tourist_android_vip_live_contId}  ${salt}  ${sign}  ${timestamp}  ${original_painting}
