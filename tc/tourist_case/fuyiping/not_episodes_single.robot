...
Suite Setup  run keyword  get file data  contId  NOT_EPISODES_SINGLE  id_save=tourist_fuyiping_not_episodes_contId
...
tourist-get-playurl-not-episodes-single-480P
    ...
    ${result}  get playurl  ${tourist_fuyiping_not_episodes_contId}  ${salt}  ${sign}  ${timestamp}  ${480P}
...
tourist-get-playurl-not-episodes-single-540P
    ...
    ${result}  get playurl  ${tourist_fuyiping_not_episodes_contId}  ${salt}  ${sign}  ${timestamp}  ${540P}
...
tourist-get-playurl-not-episodes-single-720P
    ...
    ${result}  get playurl  ${tourist_fuyiping_not_episodes_contId}  ${salt}  ${sign}  ${timestamp}  ${720P}
...
tourist-get-playurl-not-episodes-single-1080P
    ...
    ${result}  get playurl  ${tourist_fuyiping_not_episodes_contId}  ${salt}  ${sign}  ${timestamp}  ${1080P}
...
tourist-get-playurl-not-episodes-single-50-original_painting
    ...
    ${result}  get playurl  ${tourist_fuyiping_not_episodes_contId}  ${salt}  ${sign}  ${timestamp}  ${original_painting}
