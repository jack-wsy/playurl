...
Suite Setup  run keyword  get file data  contId  ABLUM_SINGLE  id_save=tourist_h5_ablum_single_contId
...
tourist-get-playurl-ablum-single-480P
    ...
    ${result}  get playurl  ${tourist_h5_ablum_single_contId}  ${salt}  ${sign}  ${timestamp}  ${480P}
...
tourist-get-playurl-ablum-single-540P
    ...
    ${result}  get playurl  ${tourist_h5_ablum_single_contId}  ${salt}  ${sign}  ${timestamp}  ${540P}
...
tourist-get-playurl-ablum-single-720P
    ...
    ${result}  get playurl  ${tourist_h5_ablum_single_contId}  ${salt}  ${sign}  ${timestamp}  ${720P}
...
tourist-get-playurl-ablum-single-1080P
    ...
    ${result}  get playurl  ${tourist_h5_ablum_single_contId}  ${salt}  ${sign}  ${timestamp}  ${1080P}
...
tourist-get-playurl-ablum-single-50-original_painting
    ...
    ${result}  get playurl  ${tourist_h5_ablum_single_contId}  ${salt}  ${sign}  ${timestamp}  ${original_painting}
