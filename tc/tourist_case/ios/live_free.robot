...
Suite Setup  run keyword  get file data  contId  LIVE_FREE  id_save=tourist_ios_live_free_contId
...
tourist-get-playurl-live-free-480P
    ...
    ${result}  get playurl  ${tourist_ios_live_free_contId}  ${salt}  ${sign}  ${timestamp}  ${480P}
...
tourist-get-playurl-live-free-540P
    ...
    ${result}  get playurl  ${tourist_ios_live_free_contId}  ${salt}  ${sign}  ${timestamp}  ${540P}
...
tourist-get-playurl-live-free-720P
    ...
    ${result}  get playurl  ${tourist_ios_live_free_contId}  ${salt}  ${sign}  ${timestamp}  ${720P}
...
tourist-get-playurl-live-free-1080P
    ...
    ${result}  get playurl  ${tourist_ios_live_free_contId}  ${salt}  ${sign}  ${timestamp}  ${1080P}
...
tourist-get-playurl-live-free-50-original_painting
    [Documentation]  游客播放直播免费节目-1080P
    ${result}  get playurl  ${tourist_ios_live_free_contId}  ${salt}  ${sign}  ${timestamp}  ${original_painting}
