...
Suite Setup  run keyword  get file data  contId  5G_ORIGINAL_PAINTING  id_save=tourist_ipad_5g_original_painting_contId
...
tourist-get-playurl-5g-original-painting-480P
    ...
    ${result}  get playurl  ${tourist_ipad_5g_original_painting_contId}  ${salt}  ${sign}  ${timestamp}  ${480P}
...
tourist-get-playurl-5g-original-painting-540P
    ...
    ${result}  get playurl  ${tourist_ipad_5g_original_painting_contId}  ${salt}  ${sign}  ${timestamp}  ${540P}
...
tourist-get-playurl-5g-original-painting-720P
    ...
    ${result}  get playurl  ${tourist_ipad_5g_original_painting_contId}  ${salt}  ${sign}  ${timestamp}  ${720P}
...
tourist-get-playurl-5g-original-painting-1080P
    ...
    ${result}  get playurl  ${tourist_ipad_5g_original_painting_contId}  ${salt}  ${sign}  ${timestamp}  ${1080P}
...
tourist-get-playurl-5g-original-painting-50-original_painting
    ...
    ${result}  get playurl  ${tourist_ipad_5g_original_painting_contId}  ${salt}  ${sign}  ${timestamp}  ${original_painting}
