...
Suite Setup  run keyword  get file data  contId  VIP_LIVE_LOOK_BACK  id_save=tourist_miniprogram_vip_live_look_back_contId
...
tourist-get-playurl-vip-live-look-back-480P
    ...
    ${result}  get playurl  ${tourist_miniprogram_vip_live_look_back_contId}  ${salt}  ${sign}  ${timestamp}  ${480P}
...
tourist-get-playurl-vip-live-look-back-540P
    ...
    ${result}  get playurl  ${tourist_miniprogram_vip_live_look_back_contId}  ${salt}  ${sign}  ${timestamp}  ${540P}
...
tourist-get-playurl-vip-live-look-back-720P
    ...
    ${result}  get playurl  ${tourist_miniprogram_vip_live_look_back_contId}  ${salt}  ${sign}  ${timestamp}  ${720P}
...
tourist-get-playurl-vip-live-look-back-1080P
    ...
    ${result}  get playurl  ${tourist_miniprogram_vip_live_look_back_contId}  ${salt}  ${sign}  ${timestamp}  ${1080P}
...
tourist-get-playurl-vip-live-look-back-50-original_painting
    [Documentation]  游客播放VIP直播回看节目-1080P
    ${result}  get playurl  ${tourist_miniprogram_vip_live_look_back_contId}  ${salt}  ${sign}  ${timestamp}  ${original_painting}
